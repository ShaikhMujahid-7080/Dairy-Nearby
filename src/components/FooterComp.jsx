...
import dairynearbynobgIcon from '../assets/dairynearbyIcon-nobg.png'
      ...
      <footer className='relative w-full mt-2'>
        <div className='mx-auto w-full max-w-7xl px-8'>
          <div className='grid grid-cols-1 justify-between gap-4 md:grid-cols-2'>
            ...
            <img src={dairynearbynobgIcon} alt="brand" className="w-28" />
              Dairy Nearby
            </Typography>
            <div className='flex grid-clos-3 justify-between gap-x-6 gap-y-4'>
          ...
          <div className='mt-10 flex w-full flex-col items-center justify-center gap-4 border-t border-surface py-4 md:flex-row md:justify-between'>
            <Typography type='small' className='text-center'>
              &copy; {YEAR}{" "}
              <a href='#'>Dairy Nearby</a>. All Rights Reserved.
            </Typography>
